...
/**
 * The graphical user interface for the edit building pop-up view
 * Edit building pop-up view
 */
public class EditBuildingGUI extends Application{

    /**
     * Creates the stage for the edit building view using the EditBuilding.fxml file
     * @param stage
     * @throws IOException
     */
    @Override
